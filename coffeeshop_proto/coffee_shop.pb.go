...
type Item struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Name          float64                `protobuf:"fixed64,2,opt,name=name,proto3" json:"name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_coffee_shop_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\x01R\x04name2\xc0\x01\n" +
	"\n" +
	"CoffeeShop\x128\n" +
	...
	"\x0eGetOrderStatus\x12\x13.coffeeshop.Receipt\x1a\x17.coffeeshop.OrderStatus\"\x00B.Z,github.com/unsubstantiated-Script/gRPCCoffeeb\x06proto3"
